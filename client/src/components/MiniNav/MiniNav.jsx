                            ...
                            </li>
                            {
                                pagelocation.map((page, index) => {
                                    if (page !== "") {
                                        ...
                                        return (
                                            <li className="text-sm flex flex-wrap" key={index}>
                                                <Link
                                                    className="flex  break-words break-all items-center text-gray-500 hover:text-cyan-600"
                                                    to={`/${page}`}
                                                >
                                                    {String(page).substring(0, 20)}
